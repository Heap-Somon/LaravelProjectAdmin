                  ...
                  <tr id="category-row-{{ $data -> id }}">
                    <td>
                      <ul class="list-unstyled users-list m-0 avatar-group d-flex align-items-center">
                        <img src="./image/{{ $data -> thumbnail }}" alt="Avatar" style="width: 100px">
                      </ul>
                    </td>
                    <td><span class="badge bg-label-primary me-1">{{ $data -> created_at }}</span></td>
                    <td>
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu position-absolute z-3" >
                          <a class="dropdown-item" href="/update/logo/{{ $data -> id }}"><i class="bx bx-edit-alt me-1"></i> Edit</a>
                          <a class="dropdown-item" id="remove-post-key" data-value="{{ $data -> id }}" data-bs-toggle="modal" data-bs-target="#basicModal" href="javascript:void(0);">
