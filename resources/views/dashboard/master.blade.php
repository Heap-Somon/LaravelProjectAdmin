        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              ...
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="/list/product/" class="menu-link">
                    <div data-i18n="Without menu">View Post</div>
                  </a>
                </li>
                <li class="menu-item">
              ...
              <ul class="navbar-nav flex-row align-items-center ms-auto">
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                    ...
                    <img src="{{ asset('image/'. Auth::user()->profile) }}" alt class="w-px-40 h-px-40 rounded-circle " style="object-fit: cover;"/>
                    </div>
                  </a>
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="d-flex">
                          <div class="flex-shrink-0 me-3">
                            <div class="avatar avatar-online">
                            <img src="./image/{{ Auth::user()->profile }}" alt class="w-px-40 h-px-40 rounded-circle" style="object-fit: cover;"/>
                            </div>
                          </div>
